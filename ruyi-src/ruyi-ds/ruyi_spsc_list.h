...
void ruyi_spsc_list_push(ruyi_spsc_list_t*, void*); /* mt-unsafe */
void* ruyi_spsc_list_pop(ruyi_spsc_list_t*); /* mt-unsafe, users should free return val after used */
void ruyi_spsc_list_destroy(ruyi_spsc_list_t**); /* mt-unsafe, ensure list is not accessed before this function called */

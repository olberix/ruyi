...
void ruyi_mpsc_list_destroy(ruyi_mpsc_list_t**, ruyi_mpsc_list_val_free_t); /* mt-unsafe, ensure list is not accessed before this function called, or memory may be leaked */

...
void ruyi_mpsc_list_push(ruyi_mpsc_list_t*, void*); /* mt-safe */
void* ruyi_mpsc_list_pop(ruyi_mpsc_list_t*); /* mt-unsafe, users should free return val after used */
void ruyi_mpsc_list_destroy(ruyi_mpsc_list_t**); /* mt-unsafe, ensure list is not accessed before this function called */
